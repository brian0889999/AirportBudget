...
namespace AirportBudget.Server.Migrations
{
    ...
    [Migration("20240814025912_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirportBudget.Server.Models.Subject7", b =>
                {
                    b.HasOne("AirportBudget.Server.Models.Subject6", "Subject6")
                        .WithMany("subject7s")
                        .HasForeignKey("Subject6Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Subject6");
                });

            modelBuilder.Entity("AirportBudget.Server.Models.Subject8", b =>
                {
                    b.HasOne("AirportBudget.Server.Models.Subject7", "Subject7")
                        .WithMany("Subject8s")
                        .HasForeignKey("Subject7Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Subject7");
                });
